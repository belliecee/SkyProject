...
/*                     //echo json_encode($project_id);
  ...
  */
          ...
          public function actionTheproject()
	{
                ...
                $this->render('theproject',array('projectNo'=>$p1,'machineType'=>$p2,'status'=>$p3,'customer'=>$p4,'vendor'=>$p5));
        } 
        ...
        public function actionComplete()
	{
                ...
                $this->render('complete',array('projectNo'=>$p1,'customer'=>$p2,'quoteDate'=>$p3,'quoteNo'=>$p4,'vendor'=>$p5,'product'=>$p6,'customerPOdate'=>$p7,'deliveryDate'=>$p8,'paymentDate'=>$p9)); 

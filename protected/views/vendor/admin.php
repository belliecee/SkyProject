...
<div class="title2" style="border-bottom: none;">Vendor</div>
                        ...
                        'buttons'=>array(
                                    ...
                                    (
                                       // 'label'=>'Send an e-mail to this user',
                                        ...
                                        'url'=>'Yii::app()->createUrl("vendor/update", array("id"=>$data->id))',
                                    ),
                                    'delete' => array
                                    (
                                       
                                    
                                        'url'=>'Yii::app()->createUrl("vendor/remove", array("id"=>$data->id))',

...
?>                    
 ...
 <script>
  $(function() {
      ...
      var product = $("#product1"),vendor = $("#vendor1"), type = $("#ttype1") ,
      qty = $("#qty1"),
    ...
    $(".update").click(function(){
               ...
               if(machinetype == 2){
                    $("#ttype1").val($(row_id+" td:nth-child(4)").text());
                    $("#qty1").val($(row_id+" td:nth-child(5)").text());
                    $("#unitPrice1").val($(row_id+" td:nth-child(6)").text());
               }else{
  ...
  <fieldset style="margin-left: -30px;">
      <?php echo $form->errorSummary($pod_model); ?>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Type</span>&nbsp;&nbsp;
                       ...
                       <select name="ttype" id="ttype1"   class="text ui-widget-content ui-corner-all" style="width:200px">
                          <?php

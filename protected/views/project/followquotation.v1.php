             ...
             <?php 
              ...
              ?>
                               ...
                               <tr class="table_tr_quod" >
                                ...
                                <td><center><?php  if($row['vendor'] === null || $row['vendor'] === ""){echo "-";} else{ echo $row['vendor'];} ?></center></td>
                                <td><center><?php  if($row['product'] === null || $row['product'] === ""){echo "-";} else{ echo $row['product'];} ?></center></td>
                               <td><center><?php   if($row['type'] === null || $row['type'] === ""){echo "-";} else{ echo $row['type'];} ?></center></td>
                               <td><center><?php   if($row['qty'] === null || $row['qty'] === ""){echo "-";} else{ echo $row['qty'];} ?></center></td>
                              <td><center><?php   if($row['unitPrice'] === null || $row['unitPrice'] === ""){echo "-";} else{ echo $row['unitPrice'];} ?></center></td>
             
                                <td><center><?php if($quote != null) echo CHtml::link($quote[0]['lastfollowedDate'],array('quotefollow/index','quoh_id'=>$row['quoh_id'],'project_id'=>$row['project_id']));  ?></center></td>
                                <td><center><?php  if($quote != null) echo $quote[0]['lastcontact']; ?></center></td>
                                <td><center><?php if($quote != null) echo $quote[0]['lastdetail']; ?></center></td>
                                <td><center><?php if($quote){ echo $quote[0]['username'];} //if( user::model()->findByPk($quote[0]['username'])) echo user::model()->findByPk($quote[0]['followedBy'])->username;} ?></center></td>
                               </tr>  

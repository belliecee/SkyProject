...
class quod extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('lineNo, quoH_id, vendor_id, product_id, qty, lineTotal', 'length', 'max'=>10),
			array('enquiryDate, remark', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, quoteNo, enquiryDate, lineNo, quoH_id, vendor_id, product_id, type_id, qty, unitPrice, lineTotal, remark', 'safe', 'on'=>'search'),
		);
	}

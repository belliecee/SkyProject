...
class user extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('givenname, lastname, email, username, password, homephone, address1, address2', 'length', 'max'=>256),
			array('auth, postcode', 'length', 'max'=>64),
			array('officephone, cellphone, city, country', 'length', 'max'=>128),
			array('registereddate, updatedate, last_time_login, profile', 'safe'),
			// The following rule is used by search().
			 array('password_repeat', 'safe'),
                        // Please remove those attributes that should not be searched.
			array('id, givenname, lastname, email, username, password, auth, registereddate, updatedate, last_time_login, officephone, cellphone, homephone, profile, address1, address2, city, country, postcode, capacity, available_monday, available_tuesday, available_wednesday, available_thursday, available_friday, available_saturday, available_sunday', 'safe', 'on'=>'search'),
		);
	}
